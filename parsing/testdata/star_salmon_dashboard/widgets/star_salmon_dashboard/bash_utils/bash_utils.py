...
class OWbash_utils(OWBwBWidget):
    ...
    inputs = [("outputDir",str,"handleInputsoutputDir"),("genomeDir",str,"handleInputsgenomeDir"),("starversion",str,"handleInputsstarversion"),("readFilesIn",str,"handleInputsreadFilesIn"),("download_trigger",str,"handleInputsdownload_trigger"),("trim_trigger",str,"handleInputstrim_trigger"),("apelist",str,"handleInputsapelist"),("spelist",str,"handleInputsspelist"),("multipleSample",str,"handleInputsmultipleSample"),("test",str,"handleInputstest")]
    ...
    def handleInputsreadFilesIn(self, value, *args):
        if args and len(args) > 0: 
            ...
            self.handleInputs("inputFile", value, None, False)
    def handleInputsdownload_trigger(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("download_trigger", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
    def handleInputstrim_trigger(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("trim_trigger", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
    def handleInputsapelist(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("apelist", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
    def handleInputsspelist(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("spelist", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
    def handleInputsmultipleSample(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("multipleSample", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
    def handleInputstest(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("test", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
