...
class OWUtilities_fastqDump(OWBwBWidget):
    ...
    inputs = [("Trigger",str,"handleInputsTrigger"),("OutputDir",str,"handleInputsOutputDir"),("sraids",str,"handleInputssraids"),("splitFiles",str,"handleInputssplitFiles")]
    outputs = [("OutputDir",str),("splitFiles",str)]
    ...
    def handleInputssraids(self, value, *args):
        if args and len(args) > 0: 
            ...
            self.handleInputs("inputFile", value, None, False)
    def handleInputssplitFiles(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("splitFiles", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
    def handleOutputs(self):
        ...
        outputValue=None
        if hasattr(self,"splitFiles"):
            outputValue=getattr(self,"splitFiles")
        self.send("splitFiles", outputValue)
