...
class OWTrimgalore(OWBwBWidget):
    ...
    inputs = [("inputFiles",str,"handleInputsinputFiles"),("basenames",str,"handleInputsbasenames"),("trigger",str,"handleInputstrigger"),("outputDir",str,"handleInputsoutputDir"),("trigger2",str,"handleInputstrigger2"),("paired",str,"handleInputspaired")]
    ...
    def handleInputstrigger2(self, value, *args):
        if args and len(args) > 0: 
            ...
            self.handleInputs("inputFile", value, None, False)
    def handleInputspaired(self, value, *args):
        if args and len(args) > 0: 
            self.handleInputs("paired", value, args[0][0], test=args[0][3])
        else:
            self.handleInputs("inputFile", value, None, False)
