...
class OWsalmon(OWBwBWidget):
    ...
    inputs = [("transcriptome",str,"handleInputstranscriptome"),("alignmentfiles",str,"handleInputsalignmentfiles"),("gtffile",str,"handleInputsgtffile"),("trigger",str,"handleInputstrigger"),("outputdir",str,"handleInputsoutputdir")]
